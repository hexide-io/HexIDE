...
Adding, deleting, moving, resizing, pasting, reordering, locking, editing a property, and every bulk
arrangement command SHALL each be reversible, and reversing SHALL be repeatable in the forward direction.
...
SHALL produce a single step covering all of it.
