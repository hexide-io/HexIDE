...
public partial class ColorPaletteToolViewModel : Tool
{
    ...
    public ColorPaletteToolViewModel(IDocumentDockService documentDockService)
    {
    ...
    public void OnSelectedColorChanged()
    {
        ...
        if (documentDockService.ActiveDocument is not FormEditViewModel formEdit)
            return;
...
public partial class ColorPaletteViewModel
{
    ...
    {
        this.vm = vm;
        this.color = VBColorAvaloniaExtensions.FromAvaloniaColor(color);
    }
