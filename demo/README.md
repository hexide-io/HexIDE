...
> **Note:** most demos above are graphical demoscene intros built by driving the live IDE through MCP. The
> [battleship](battleship/) entry is a different beast — a hand-written VBA program archived as an end-to-end
> **fidelity cross-check** (the same source runs identically on HexIDE's tree-walking interpreter and on the real
> VB6 compiler).
