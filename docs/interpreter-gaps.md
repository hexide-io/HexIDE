...
- **Sequential/Random file I/O** (Open, Close, Print#, Write#, Input#, Line Input#, Get, Put, Seek, Lock, Unlock, Reset, Width#) — every visitor throws, no handle machinery; VB6 full channel-based file family. Documented post-launch: MISSING_FEATURES.md:504, TODO.md:127, ROADMAP.md:77,154.
...
- **File-related functions** (FreeFile, EOF, LOF, Loc, Seek fn, FileLen, Dir/Dir$, CurDir, GetAttr, FileDateTime, FileAttr, Input$, Spc, Tab) — absent from the builtin registry; companions to the deferred channel statements. Documented family-level (interpreter-core "fidelity roadmap", MISSING_FEATURES.md:504, TODO.md:127).
...
- **GoSub/Return, On expr GoTo/GoSub** — all four throw; VB6 legacy in-procedure computed branching. Deferred pending linearized CFG/bytecode: interpreter-core "fidelity roadmap" line 524, TODO.md:128.
...
- **Like operator** (`s Like "a*b"`) — unconditional throw (ExpressionExecutor.cs:872); VB6 pattern match under Option Compare. Deferred at TODO.md:126.
...
- **Resume granularity (fault nested in a construct) & unbounded recursion (Error 28)** — nested-granular Resume is a stated 5b limitation (needs CFG/bytecode); missing Error-28 depth guard tracked as E6 ("parked, not dropped"). interpreter-core Subset 5b; interpreter-advanced E6, ROADMAP Phase 4.1.
